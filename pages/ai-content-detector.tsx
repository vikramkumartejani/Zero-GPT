            ...
            <div className="relative overflow-hidden">
                ...
                <div className="relative z-40 h-full pt-[120px] md:pt-[180px] pb-[220px] px-3.5">
                    <div className="text-center">
                        <h1 className="text-dark-blue font-bold text-2xl sm:text-3xl md:text-4xl lg:text-5xl lg:leading-[58px] max-w-[864px] mx-auto uppercase">Ai Content Detector</h1>
